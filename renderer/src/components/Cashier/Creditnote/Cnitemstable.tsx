      ...
      <div className="cn-col-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="cn-col-modal-body">
          ...
          <div className="cn-col-notice">
            ...
            <span className="cn-col-notice-link">Items page (click here)</span>
          </div>
        </div>
      ...
      <table className="cn-items-table">
        ...
        <tbody>
            ...
            return (
              <tr key={item.rowId} className="cn-items-row">
                ...
                <td className="cn-items-td">
                  <input
                    className="cn-items-input cn-items-input--sm"
                    value={item.hsn || ""}
                ...
                {columns.quantity && (
                  <td className="cn-items-td">
                    <div className="cn-items-qty-row">
                      <input
                        className="cn-items-input cn-items-input--num"
                        type="number" min={0}
                        value={item.qty}
                ...
                <td className="cn-items-td">
                  <div className="cn-items-disc-col">
                    <div className="cn-items-disc-row">
                      ...
                      <input className="cn-items-input cn-items-input--num" type="number" min={0} max={100}
                        value={item.discountPct} onChange={e => updateItem(item.rowId, "discountPct", Number(e.target.value))} />
                    </div>
                    <div className="cn-items-disc-row">
                      <span className="cn-items-disc-symbol">₹</span>
                      <input className="cn-items-input cn-items-input--num" type="number" min={0}
                ...
                <td className="cn-items-td cn-items-td--tax">
                  <select className="cn-items-tax-sel" value={item.taxLabel}
                ...
                <td className="cn-items-td cn-items-td--amount">
                ...
                <td className="cn-items-td cn-items-td--del">
                  <button className="cn-items-del-btn" onClick={() => removeItem(item.rowId)}>
          ...
          <tr className="cn-items-add-row">
            <td colSpan={6 + (columns.quantity ? 1 : 0) + (columns.pricePerItem ? 1 : 0)} className="cn-items-add-cell">
