...
const BillForm: React.FC<BillFormProps> = ({ mode = "sale", isAutomated = false }) => {
  ...
  // Keyboard shortcut handler for Add Items Modal
  useEffect(() => {
  ...
  }, [showAddItemsModal, selectedInventoryItems]);
          ...
          <div style={{ maxWidth: '1600px', margin: '0 auto', display: 'flex', gap: '24px' }}>
            ...
            <div style={{ width: '320px' }}>
              ...
              <div style={{ backgroundColor: '#ffffff', borderRadius: '8px', padding: '20px' }}>
                ...
                {!isFromPurchase && !isDebitNote && !isPurchaseReturn && !isCreditNote && !isDeliveryChallan && !isPurchaseOrder && (
                  <>
                    {/* Invoice Prefix */}
                    <div style={{ marginBottom: '16px' }}>
                      <label
                ...
                {isPurchaseOrder && (
                  <>
                    ...
                    >
                      {/* Invoice Prefix */}
                      <div>
                        <label style={{ fontSize: "10px", color: "#6b7280" }}>
                          Invoice Prefix:
                        </label>
                        <input
                          value="ME/PO/26-27/"
                      ...
                      <div >
                        ...
                        >
                          ...
                          <span style={{ fontSize: "14px" }}>10 Feb 2026</span>
                        </div>
                      </div>
                    </div>   
                  </>
                  ...
                  <>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input value="1" readOnly style={inputStyle} />
                      </div>
                  ...
                  <>
                    ...
                    >
                      <div>
                        ...
                        <input value="2" readOnly style={inputStyle} />
                      </div>
                      ...
                      <div>
                        ...
                        <input value="10 Feb 2026" style={inputStyle} />
                      </div>
                    </div>
                ...
                {/* Add Due Date (NOT for Debit Note) */}
                {!isDebitNote && !isPurchaseReturn && !isCreditNote && !isPurchaseOrder && (
                  <>
                    {!showDueDate ? (
                      <div 
