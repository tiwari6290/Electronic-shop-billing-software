...
export default function PaymentInList() {
  ...
  return (
    <div className="paymentinlist-page">
      <div className="paymentinlist-header">
        <div>
          <h2>Payment In</h2>
      ...
      <div className="paymentinlist-toolbar">
        ...
        <button
          ...
          onClick={() => navigate("/cashier/payment-in")}
        >
          Create Payment In
        </button>
      </div>

      <div className="paymentinlist-table-wrapper">
        <table className="paymentinlist-table">
          <thead>
            <tr>
              <th>Date ⇅</th>
